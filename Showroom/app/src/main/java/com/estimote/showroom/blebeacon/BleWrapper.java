...
public class BleWrapper 
{
    ...
    /// Viet ///
    public String getDeviceUuid() { return mDeviceUuid; }
	...
	/// Viet
	public String getUuidString(BluetoothDevice BtDevice)
	{
		ParcelUuid[] DevUuid = BtDevice.getUuids();
		if (DevUuid != null)
			mDeviceUuid = DevUuid.toString();
		else
			mDeviceUuid = "x";
		return mDeviceUuid;		
	}
    ...
    private BluetoothAdapter.LeScanCallback mDeviceFoundCallback = new BluetoothAdapter.LeScanCallback()
    {
        ...
        {
			String strUuid = getUuidString(device);
        	mUiCallback.uiDeviceFound(device, rssi, scanRecord, strUuid);			
        }
    };	    
